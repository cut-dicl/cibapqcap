...
%writematrix(BT_PSO, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\BT_PSO10v1d1q.txt"); 
%writematrix(BP_PSO, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\BP_PSO10v1d1q.txt");
%writematrix(BQ_PSO, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\BQ_PSO10v1d1q.txt");
%writematrix(NC_PSO, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\NC_PSO10v1d1q.txt");
writematrix(Time_PSO, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\Time_PSO10v1d1q.txt");
%writematrix(PSO_BestCost, "C:\Users\PC\OneDrive - Cyprus University of Technology\00MQbapQcap_code\00BAP_QCAP_RandomData\Results\Cost_PSO10v1d1q.txt");
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
