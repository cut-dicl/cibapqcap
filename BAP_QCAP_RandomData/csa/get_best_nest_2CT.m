...
function [fmin, bestNest, nest, fitness1, data,PBQ_changed]=get_best_nest_2CT(nest,newnest,fitness, data, lengthOfwharf,iteration,PBQ_changed, pTime_new)
...
ShipNo_BQChange=[]; x=0; pTime=pTime_new(iii,:);
