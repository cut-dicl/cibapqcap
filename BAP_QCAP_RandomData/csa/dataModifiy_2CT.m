function [AT_30min_R, dep_30min_R, pTime]=dataModify_2CT(DataTable,DataTable2) %


AT_30min_R=DataTable2.ArrivalTimeOfVessel*2;
dep_30min_R=DataTable2.RequestedDep_Time*2;
...
pTime=pTime(1:length(AT_30min_R));
