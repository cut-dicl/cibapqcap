function [Optimal_processing_time PBP possible_cranes cranes_numbers]=optimal_time_calculation(Load, max_cranes, HP,pTime,PBQ, PBP, LoS, LoW,Total_containers)
