...
function [bestNest_so_Far,min_ObjVal, nest, D, pa]=cuckoo_search(nest, noOfGeneration, n, data, LoW, pTime_new,cranes_numbers,Total_containers) %this function ends on line 97
...
PBQ_changed=[];
%[cost]=qqq(Quay, LoW);
[fmin, bestNest, nest, fitness1, data,PBQ_changed]=get_best_nest(nest,nest1,fitness, data, LoW,count,PBQ_changed, pTime_new);
...
%%%%%%%%%%%%%%%%%%%############### SECOND STEP generete new solutions
    % Generate new solutions (but keep the current best)
     new_nest=get_cuckoos(nest,bestNest,data,LoW,PBQ_changed,pTime_new,cranes_numbers);   
     pTime_new=pTime_new_calculation(data, n, new_nest,Total_containers); % this function calculates new processing time based on modified number of cranes


     [fnew1,best1,nest,fitness, data,PBQ_changed]=get_best_nest(nest,new_nest,fitness, data, LoW,count,PBQ_changed, pTime_new);
    % Update the counter
    ...
    % Evaluate this set of solutions
     [fnew2,best2,nest,fitness, data,PBQ_changed]=get_best_nest(nest,new_nest,fitness, data, LoW,count,PBQ_changed, pTime_new);
      fnew2;
