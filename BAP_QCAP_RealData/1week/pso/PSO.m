...
[BT BP BQ NC pTime_new]=random_population(LoS, data.AT, data.dep, pTime, LoW, PBP, PBQ, nPop, Load, max_cranes, HP, cranes_numbers,Total_containers); % random population generation % NC is number of cranes 
NewPop=[BT BP BQ NC];
