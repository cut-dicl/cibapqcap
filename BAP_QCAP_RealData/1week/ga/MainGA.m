...
writematrix(BT_GA, "C:\Users\Sheraz\Downloads\BT_GA.txt"); 
writematrix(BP_GA, "C:\Users\Sheraz\Downloads\BP_GA.txt");
writematrix(BQ_GA, "C:\Users\Sheraz\Downloads\BQ_GA.txt");
writematrix(NC_GA, "C:\Users\Sheraz\Downloads\NC_GA.txt");
%writematrix(data.PBP, "C:\Users\Sheraz\Dropbox\Journal code\temp\results\used_PBP.txt");
writematrix(Time_GA, "C:\Users\Sheraz\Downloads\Time_GA.txt");
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
