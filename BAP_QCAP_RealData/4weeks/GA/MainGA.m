...
%BT_GA=bestSolutionWithoutCost(1:138);
%BP_GA=bestSolutionWithoutCost(139:276);
%BQ_GA=bestSolutionWithoutCost(277:414);
%[x1]=mainplot(BT_GA, BP_GA, data.pTime, data.LoS, 2); % plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
