function [pTime_new]=pTime_new_calculation4(data, n, new_nest, Total_containers) % NC --> number of cranes
NC_new=new_nest(:,(end-length(data.AT))+1:end); % storing new number of cranes after random walk.. so we can calculate new processing time
